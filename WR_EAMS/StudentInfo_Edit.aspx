<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentInfo_Edit.aspx.cs" Inherits="WR_EAMS.StudentInfo_Edit" %>
        ...
        <table border="1" class="style1" >
            ...
            <tr>
                <td>
                   班　级</td>
                <td>
                    <asp:TextBox ID="txt_Class" runat="server" Width="150px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
