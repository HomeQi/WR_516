<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Score_Edit.aspx.cs" Inherits="WR_EAMS.Score_Edit" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="rightinfo">
            ...
            <asp:GridView ID="Students_gv" runat="server" AutoGenerateColumns="False" DataKeyNames="sId" CssClass="tablelist" AllowPaging="True" OnRowCancelingEdit="Students_gv_RowCancelingEdit" OnRowEditing="Students_gv_RowEditing" OnRowUpdating="Students_gv_RowUpdating" OnPageIndexChanging="Students_gv_PageIndexChanging" >
                <Columns>
                    <asp:BoundField DataField="ID" HeaderText="成绩编号" ReadOnly="true"/>
                    <asp:BoundField DataField="sId" HeaderText="学号" ReadOnly="True" SortExpression="sId" />
                    <asp:BoundField DataField="sName" HeaderText="姓名" SortExpression="sName" ReadOnly="true"/>
                    <asp:BoundField DataField="sClass" HeaderText="班级" SortExpression="sClass" ReadOnly="true"/>
                    <asp:BoundField DataField="Course" HeaderText="课程名称" SortExpression="Course" ReadOnly="true"/>
